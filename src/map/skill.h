...
enum e_skill {
	...
	NJ_ISSEN,
	/**Rock And Ro Mod*/
	NSC_HOLYBOLT,/**MB_FIGHTING,*/
	NSC_DARKJUPITEL,/**MB_NEUTRAL,*/
	NSC_VENOMBOLT,/**MB_TAIMING_PUTI,*/
	NSC_HOLYHEAVENDRIVE,/**MB_WHITEPOTION,*/
	MB_MENTAL,
	NSC_DECBLESSING,/**MB_CARDPITCHER,*/
	MB_PETPITCHER,
	MB_BODYSTUDY,
	MB_BODYALTER,
	MB_PETMEMORY,
...
// will have their IDs changed
	...
	NPC_WIDEWEB,
	NPC_WIDESUCK,
	NPC_STORMGUST2,/**NSC_POISONSTORMGUST,*/
	NPC_FIRESTORM,
	NPC_REVERBERATION,
